...
public abstract class AbstractGame implements Logic {
	...
	public void saveGame() {
		...
		// modified: here we save the winner name in file system.
	try {
		BufferedWriter out = new BufferedWriter(new FileWriter("winner.txt"));
		com.theaigames.game.player.AbstractPlayer win = (this.processor.getWinner());
		if(win==null){
			out.write("nobody");
			out.close();
		}
		else{
			out.write(win.getName());
			out.close();
		}
	}
	catch (IOException e)
